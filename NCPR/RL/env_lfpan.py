...
from FPAN_lastfm.recmodel import MyRec
from FPAN_lastfm.recsysconfig import recsysconfig
import torch

class LFPANEnv(object):
    def __init__(self, kg, dataset, data_name, seed=1, max_turn=15, cand_len_size=20, attr_num=20, mode='train', command=1, ask_num=1, entropy_way='weight entropy', fm_epoch=250, method='none', hyper = 0.3):
        ...
        # self.load_model("iter5-2021-05-05", False)
        self.load_embeds()
        # action parameters
    ...
    def update_user_embedding(self):
        ...
        pos_att_mask = [True] * len(self.user_acc_feature)
        ...
        if len(self.user_rej_feature) == 0:
            ...
            neg_att_mask = [True] * len(self.user_rej_feature)
        ...
        neg_att_list = torch.tensor(self.user_rej_feature)
