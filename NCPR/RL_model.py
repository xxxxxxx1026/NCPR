...
def main():
    ...
    parser.add_argument('--hyper', type=float, default=0.3, help='xxxxx')
    parser.add_argument('--method', type=str, default='cos', choices=['jaccard', 'cos', 'pearson', 'none'],)
    ...
    # list1 = [
    #     ['cos', 0.1, 4000],['cos', 0.2, 4000],['cos', 0.3, 4000],['cos', 0.4, 4000],['cos', 0.5, 4000],
    # ]
    # for i in range(len(list1)):
    #     args.method = list1[i][0]
    #     args.hyper = list1[i][1]
